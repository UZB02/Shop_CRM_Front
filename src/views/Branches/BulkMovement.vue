...
import BulkMovementSidebar from '@/views/Warehouse/components/BulkMovement/BulkMovementSidebar.vue'
import BulkMovementTable from '@/views/Warehouse/components/BulkMovement/BulkMovementTable.vue'
