        ...
        <div class="flex items-center gap-2 mt-0.5 flex-wrap">
          ...
          <template v-else>
            <div class="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-emerald-500/5 text-emerald-500 border border-emerald-500/10 dark:bg-emerald-500/10">
              ...
              <span class="text-[8px] sm:text-[9px] font-black uppercase tracking-wider">Faol</span>
            </div>
            <span v-if="periodText" class="text-[8px] sm:text-[9px] font-black text-slate-400 uppercase tracking-widest hidden md:inline border-l border-slate-200 dark:border-slate-800 pl-2 ml-1">
              {{ periodText }}
            </span>
          </template>
        </div>
    ...
    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 grow lg:grow-0">
      ...
      <div class="relative group flex-1 lg:flex-none">
        <DatePicker
          ...
          pt:input:class="!w-full lg:!w-[200px] !h-10 !rounded-xl !border !border-slate-200/60 dark:!border-slate-700/40 !bg-white dark:!bg-slate-800/80 focus:!border-emerald-500/50 !text-[10px] !font-black !pl-4 !shadow-sm !uppercase !text-slate-700 dark:!text-slate-200"
        />
      </div>
      ...
      <div class="relative group flex-1 lg:flex-none min-w-0">
        ...
        <Select
          ...
          pt:label:class="!text-[10px] !font-black !flex !items-center !py-0 !pl-9 !pr-4 !uppercase !text-slate-700 dark:!text-slate-200 truncate"
        />
      </div>
      ...
      <div class="flex items-center gap-1.5 shrink-0 ml-auto sm:ml-0">
        ...
        >
          ...
          <span class="text-[10px] font-black uppercase tracking-widest">Yangilash</span>
        </button>
      </div>
    </div>
  </div>
