    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div class="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-xl p-4 shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden group">
           ...
           <div class="flex items-center gap-3 relative z-10">
              ...
              <div>
                 <p class="text-[9px] font-bold uppercase tracking-widest text-slate-400 mb-0.5">Qarzdor mijozlar</p>
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-xl p-4 shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden group">
           ...
           <div class="flex items-center gap-3 relative z-10">
              ...
              <div>
                 <p class="text-[9px] font-bold uppercase tracking-widest text-slate-400 mb-0.5">Umumiy qarz summasi</p>
    ...
    <div class="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-xl overflow-hidden shadow-sm">
       <div class="px-4 py-3 border-b border-slate-50 dark:border-slate-800/50 flex items-center justify-between bg-slate-50/30 dark:bg-slate-800/20">
          <div class="flex items-center gap-2">
            ...
            <span class="text-[10px] font-bold uppercase tracking-widest text-slate-500">Qarzdorlar ro'yxati</span>
          </div>
       </div>
                ...
                <tr v-for="item in (data?.items || [])" :key="item.customer_id" class="hover:bg-slate-50/50 dark:hover:bg-slate-800/10 transition-colors group">
                   <td class="px-4 py-3">
                      <div class="flex flex-col">
                        ...
                        <span class="text-[9px] font-medium text-slate-400 uppercase tracking-widest mt-0.5">{{ item.phone || '—' }}</span>
                      </div>
                   </td>
                   ...
                   <td class="px-4 py-3">
                      <span class="px-2 py-0.5 rounded-lg bg-slate-50 dark:bg-slate-800 text-[9px] font-bold text-slate-500 uppercase tracking-widest border border-slate-100 dark:border-slate-800/50">
                         {{ item.sales_count }} ta
                      </span>
                   </td>
