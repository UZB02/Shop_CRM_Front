  ...
  <div class="space-y-4 animate-in">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-5 shadow-sm">
        <div class="flex items-center gap-3 mb-3">
          ...
          <span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{{ $t('shifts.debt_info.paid_now') }}</span>
        </div>
      ...
      <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-5 shadow-sm">
        <div class="flex items-center gap-3 mb-3">
          ...
          <span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{{ $t('shifts.debt_info.outstanding') }}</span>
        </div>
    ...
    <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
      <div class="px-6 py-4 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
        ...
        <span class="px-2 py-0.5 rounded bg-slate-100 dark:bg-slate-800 text-[10px] font-bold text-slate-500 uppercase">
