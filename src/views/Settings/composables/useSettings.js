...
const FORM_FIELDS = [
    ...
    'max_discount_percent', 'allow_price_markup', 'receipt_header', 'receipt_footer',
...
export const TAB_FIELDS = {
    ...
    payment: ['allow_cash', 'allow_card', 'allow_debt', 'allow_discount', 'max_discount_percent', 'allow_price_markup'],
