<template>
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4">
    ...
    <div class="bg-white dark:bg-[#131d31] p-3.5 rounded-[16px] border border-slate-200 dark:border-transparent shadow-sm flex flex-col justify-center">
      <span class="text-[8px] font-black text-slate-400 dark:text-slate-500 tracking-widest block mb-2">{{ $t('products.detail.category') }}</span>
      <div class="flex items-center gap-2.5">
        ...
        <div class="min-w-0 flex-1">
          <p class="text-[11px] font-black text-slate-800 dark:text-white leading-tight truncate">{{ product?.category_name || '---' }}</p>
    ...
    <!-- Store Card -->
    <div class="bg-white dark:bg-[#131d31] p-3.5 rounded-[16px] border border-slate-200 dark:border-transparent shadow-sm flex flex-col justify-center">
      <span class="text-[8px] font-black text-slate-400 dark:text-slate-500 tracking-widest block mb-2">{{ $t('products.detail.store') }}</span>
      <div class="flex items-center gap-2.5">
        ...
        <div class="min-w-0 flex-1">
          <p class="text-[11px] font-black text-slate-800 dark:text-white leading-tight line-clamp-2" :title="product?.store_name">{{ product?.store_name || '---' }}</p>
        </div>
      </div>
    </div>
    ...
    <!-- Purchase Price Card -->
    <div class="bg-white dark:bg-[#131d31] p-3.5 rounded-[16px] border border-slate-200 dark:border-transparent shadow-sm flex flex-col justify-center">
      <span class="text-[8px] font-black text-slate-400 dark:text-slate-500 tracking-widest block mb-2">{{ $t('products.detail.purchase_price') }}</span>
      <div class="flex items-center gap-2.5">
        ...
        <div class="min-w-0 flex-1">
          <p class="text-[11px] font-black text-slate-800 dark:text-white leading-tight truncate">
    ...
    <div class="bg-white dark:bg-[#131d31] p-3.5 rounded-[16px] border border-slate-200 dark:border-transparent shadow-sm flex flex-col justify-center relative overflow-hidden">
      ...
      <span class="text-[8px] font-black text-slate-400 dark:text-slate-500 tracking-widest block mb-2">{{ $t('products.detail.sale_price') }}</span>
      <div class="flex items-center gap-2.5">
        <div class="w-8 h-8 rounded-lg bg-emerald-50 dark:bg-emerald-500/5 text-emerald-500 flex items-center justify-center border border-emerald-100 dark:border-emerald-500/10 shrink-0">
    ...
    <!-- Unit Card -->
    <div class="bg-white dark:bg-[#131d31] p-3.5 rounded-[16px] border border-slate-200 dark:border-transparent shadow-sm flex flex-col justify-center">
      <span class="text-[8px] font-black text-slate-400 dark:text-slate-500 tracking-widest block mb-2">{{ $t('products.detail.unit') }}</span>
      <div class="flex items-center gap-2.5">
        ...
        <div class="min-w-0 flex-1">
          <p class="text-[11px] font-black text-slate-800 dark:text-white leading-tight truncate">{{ product?.unit_display }} ({{ product?.unit }})</p>
        </div>
      </div>
    </div>
    ...
    <!-- Created Date Card -->
    <div class="bg-white dark:bg-[#131d31] p-3.5 rounded-[16px] border border-slate-200 dark:border-transparent shadow-sm flex flex-col justify-center">
      <span class="text-[8px] font-black text-slate-400 dark:text-slate-500 tracking-widest block mb-2">{{ $t('products.detail.created_at') }}</span>
      <div class="flex items-center gap-2.5">
        ...
        <div class="min-w-0 flex-1">
          <p class="text-[11px] font-black text-slate-800 dark:text-white leading-tight truncate">{{ product?.created_on?.split('|')[0]?.trim() || '---' }}</p>
        </div>
      </div>
    </div>
    ...
    <div v-if="product?.ikpu_code" class="bg-white dark:bg-[#131d31] p-3.5 rounded-[16px] border border-slate-200 dark:border-transparent shadow-sm col-span-1 sm:col-span-2 flex flex-col justify-center">
      <span class="text-[8px] font-black text-slate-400 dark:text-slate-500 tracking-widest block mb-2">{{ $t('products.detail.ikpu') }}</span>
      <div class="flex items-center gap-2.5">
