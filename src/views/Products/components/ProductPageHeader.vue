<template>
  <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
    ...
    <div class="grid grid-cols-2 sm:flex sm:items-center gap-2 shrink-0">
      ...
      <!-- ✅ has_promotion: faqat tarif ruxsat bersa va module settingsdan yoqilgan bo'lsa ko'rinadi -->
      <button
        v-if="settingsStore.hasPlanPromotion && settingsStore.isPromotionEnabled"
