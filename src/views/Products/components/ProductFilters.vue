  ...
  <div class="flex flex-wrap gap-2 items-center">
    ...
    <div class="relative flex-1 min-w-[220px]">
      ...
      <input
        ...
        class="w-full h-9 pl-9 pr-8 text-[13px] font-bold rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 placeholder:text-slate-400 focus:outline-none focus:border-emerald-500 transition-all shadow-sm"
      />
      <button
        v-if="searchQuery"
        @click="onSearch('')"
    ...
    <select
      ...
      class="h-9 px-3 text-[13px] font-bold rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 focus:outline-none focus:border-emerald-500 transition-all appearance-none pr-8 min-w-[140px] shadow-sm"
    >
    ...
    <select
      ...
      class="h-9 px-3 text-[13px] font-bold rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 focus:outline-none focus:border-emerald-500 transition-all appearance-none pr-8 min-w-[120px] shadow-sm"
    >
