<template>
  <div class="bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none overflow-hidden flex flex-col">
    <div class="flex items-center gap-3 px-6 py-4 border-b border-slate-50 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-800/20 shrink-0">
      ...
      <div>
        <h2 class="text-[12px] font-black tracking-widest text-slate-800 dark:text-slate-100">{{ $t('products.form.main_info') }}</h2>
      </div>
    </div>
    ...
    <div class="p-6 space-y-6 overflow-y-auto">
      ...
      <div class="flex flex-col gap-2">
        ...
        <div class="relative group">
          ...
          <input
            ...
            class="w-full h-11 pl-11 pr-5 rounded-xl text-[14px] font-bold text-slate-800 dark:text-white bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700 outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 transition-all shadow-sm"
      ...
      <!-- Barcode -->
      <div class="flex flex-col gap-2">
        <label class="text-[12px] font-black tracking-widest text-slate-400 dark:text-slate-500 ml-1">{{ $t('products.form.barcode') }}</label>
        <div class="relative group">
