  ...
  <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
    ...
    <div class="hidden lg:flex items-center gap-2 shrink-0">
      <button
        ...
        class="h-8 px-3 rounded-lg text-sm text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all flex items-center justify-center gap-1.5 whitespace-nowrap"
      >
      ...
      <button
        ...
        class="h-8 px-3 rounded-lg text-sm font-medium transition-all flex items-center justify-center gap-1.5 whitespace-nowrap"
        :class="[
