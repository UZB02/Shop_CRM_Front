<template>
  <div class="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-1 p-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm overflow-hidden">
    <!-- Tabs -->
    ...
    <div class="flex flex-col md:flex-row items-stretch md:items-center">
      ...
      <div v-if="activeTab === 'debtors' || settingsStore.hasPlanExport" 
           class="flex items-center gap-2 px-3 py-2 md:py-1 border-t md:border-t-0 md:border-l border-slate-100 dark:border-slate-800"
           :class="activeTab === 'debtors' ? 'justify-between' : 'justify-end'">
        
        <!-- Debtors Filters -->
        <div v-if="activeTab === 'debtors'" class="relative group/min-debt flex-1 md:flex-none md:min-w-[120px]">
      ...
      <div class="flex items-center justify-between md:justify-end gap-3 px-4 py-3 md:py-1.5 bg-slate-50/50 dark:bg-slate-800/50 border-t md:border-t-0 md:border-l border-slate-100 dark:border-slate-800 transition-all min-w-fit rounded-b-lg md:rounded-none">
